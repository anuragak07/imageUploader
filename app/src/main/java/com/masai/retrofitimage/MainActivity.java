package com.masai.retrofitimage;
...
public class MainActivity extends AppCompatActivity {
   ...
   /* memorize it , it can provide gallery Activity to mainActivity and
   capture result which is chosen image from gallery
    */
    private ActivityResultLauncher<Intent> resultFromGalleryActivity = registerForActivityResult(
            new ActivityResultContracts.StartActivityForResult(), new ActivityResultCallback<ActivityResult>() {
                @Override
                public void onActivityResult(ActivityResult result) {
                    Uri selectedImageUri = result.getData().getData(); //unique data for selected Image
                    try{
                ...
                /*
                Get the Actual path from Selected URI
                EX : user/anurag/picture/screenshot/10202;
                 */
    ...
    private void initViews() {
        ...
        /*
        1. got the image uri
        2. from image uri we got the actual path of uri
        3. From the Path generate the file
         */
